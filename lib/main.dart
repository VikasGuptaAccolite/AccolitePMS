  ...
  Future<String> getData() async {
    ...
    // print("reaching out to the server!!!");
      var response = await http.get(
        ...
        //  Uri.encodeFull("https://script.google.com/a/accoliteindia.com/macros/s/AKfycbwd6Esnt_dqsxTOExgNiQD0-YUn7UCVVZ_XyzZaqMI/dev?id=19vljbQ5P-uU1d1yXrO6l5BP7CiwTzmu0UIKWR8v2_Po&sheet=Quarter-4"),
        //  Uri.encodeFull("https://script.google.com/macros/s/AKfycbw62MiIrGBtrfx59fizysETG-H2sPWUu8Z-VRI1SVT2_d91oZk/exec?id=19vljbQ5P-uU1d1yXrO6l5BP7CiwTzmu0UIKWR8v2_Po&sheet=Quarter-4&row=21&rating=&remarks=update-from-postman"),
      headers: {
